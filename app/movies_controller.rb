...
def can_be_found_updated_and_saved
  ...
  Movie.connection.execute("UPDATE movies SET title = 'Even Awesomer Flick' WHERE title = 'Awesome Flick'")
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  Movie.create(title: "Wat?")
  Movie.connection.execute("UPDATE movies SET title = 'Wat, huh?' WHERE title = 'Wat?'")
end
...
def can_update_multiple_items_at_once
  ...
  Movie.connection.execute("UPDATE movies SET title = 'A Movie'")
end

def can_destroy_a_single_item
  Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  Movie.all.where(title: "That One Where the Guy Kicks Another Guy Once").destroy_all
end
